...
@pytest.fixture
def app_with_mocks(app, mock_nhtsa_service, mock_vehicle_service):
    """Configure app with dependency overrides for NHTSA and vehicle services."""
    from app.services.nhtsa_service import get_nhtsa_service
    from app.services.vehicle_service import get_vehicle_service

    async def override_nhtsa():
        return mock_nhtsa_service

    async def override_vehicle():
        return mock_vehicle_service

    app.dependency_overrides[get_nhtsa_service] = override_nhtsa
    app.dependency_overrides[get_vehicle_service] = override_vehicle
...
class TestVINDecodeEndpoint:
    ...
    async def test_decode_invalid_vin_returns_400(
        ...
        from app.services.nhtsa_service import VINDecodeResult, get_nhtsa_service
    ...
    @pytest.mark.asyncio
    async def test_decode_vin_handles_nhtsa_error(self, async_client, seeded_db, app):
        """Test that NHTSA API error is handled gracefully."""
        from app.services.nhtsa_service import NHTSAError, get_nhtsa_service
...
class TestVehicleMakesEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_makes_returns_200(self, async_client, seeded_db, app_with_mocks):
    ...
    async def test_get_makes_returns_paginated_response(
        self, async_client, seeded_db, app_with_mocks
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_makes_have_required_fields(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_makes_with_search_filter(self, async_client, seeded_db, app_with_mocks):
...
class TestVehicleModelsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_models_returns_200(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_models_for_volkswagen(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_models_have_required_fields(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_models_unknown_make_returns_404(self, async_client, seeded_db, app):
...
class TestVehicleYearsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_years_returns_200(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_years_returns_list(self, async_client, seeded_db, app_with_mocks):
    ...
    @pytest.mark.asyncio
    async def test_get_years_sorted_descending(self, async_client, seeded_db, app_with_mocks):
...
class TestVehicleRecallsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_recalls_handles_nhtsa_error(self, async_client, seeded_db, app):
        """Test that NHTSA API error is handled gracefully."""
        from app.services.nhtsa_service import NHTSAError, get_nhtsa_service
...
class TestVehicleComplaintsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_get_complaints_handles_nhtsa_error(self, async_client, seeded_db, app):
        """Test that NHTSA API error is handled gracefully."""
        from app.services.nhtsa_service import NHTSAError, get_nhtsa_service
