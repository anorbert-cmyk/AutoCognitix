...
export const regions: RegionData[] = [
  ...
  { id: 'bacs_kiskun', name: 'B\u00E1cs-Kiskun', county: 'B\u00E1cs-Kiskun megye', lat: 46.5962, lng: 19.3610 },
  { id: 'bekes', name: 'B\u00E9k\u00E9s', county: 'B\u00E9k\u00E9s megye', lat: 46.7736, lng: 21.0877 },
  { id: 'borsod', name: 'Borsod-Aba\u00FAj-Zempl\u00E9n', county: 'Borsod-Aba\u00FAj-Zempl\u00E9n megye', lat: 48.1035, lng: 20.7784 },
  { id: 'csongrad', name: 'Csongr\u00E1d-Csan\u00E1d', county: 'Csongr\u00E1d-Csan\u00E1d megye', lat: 46.4167, lng: 20.1500 },
  { id: 'fejer', name: 'Fej\u00E9r', county: 'Fej\u00E9r megye', lat: 47.1896, lng: 18.4104 },
  { id: 'gyor_moson_sopron', name: 'Gy\u0151r-Moson-Sopron', county: 'Gy\u0151r-Moson-Sopron megye', lat: 47.6849, lng: 17.2344 },
  { id: 'hajdu_bihar', name: 'Hajd\u00FA-Bihar', county: 'Hajd\u00FA-Bihar megye', lat: 47.5316, lng: 21.6273 },
  { id: 'heves', name: 'Heves', county: 'Heves megye', lat: 47.8931, lng: 20.3727 },
  { id: 'jasz_nagykun_szolnok', name: 'J\u00E1sz-Nagykun-Szolnok', county: 'J\u00E1sz-Nagykun-Szolnok megye', lat: 47.1621, lng: 20.1825 },
  { id: 'komarom_esztergom', name: 'Kom\u00E1rom-Esztergom', county: 'Kom\u00E1rom-Esztergom megye', lat: 47.5561, lng: 18.4037 },
  ...
  { id: 'szabolcs', name: 'Szabolcs-Szatm\u00E1r-Bereg', county: 'Szabolcs-Szatm\u00E1r-Bereg megye', lat: 48.1, lng: 21.95 },
